            ...
            <div class="bg-white p-6 shadow-sm sm:rounded-lg">
                ...
                <form method="POST" action="{{ route('events.store') }}">
                    ...
                    <div class="mb-4">
                        ...
                        @if ($eventCategoryOptions->isEmpty())
                            <p class="mt-2 text-sm text-red-600">
                                No event types are available. Please add the main event types before creating an event.
                            </p>
                        @endif
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input name="title" value="{{ old('title') }}" class="w-full border-gray-300 rounded" required>
                    </div>
                    ...
                    <div id="dynamic_event_details" class="mb-6 rounded-lg border border-gray-200 bg-gray-50 p-4 hidden">
                        ...
                        <div class="dynamic-field-group hidden" data-required-for="site visit:quote walk-through,site visit:job set-up,site visit:final walk-through">
                            ...
                            <input type="text" name="details[engineer]" value="{{ old('details.engineer') }}" class="dynamic-required w-full border-gray-300 rounded" data-required-when-visible="true">
                        </div>
                        ...
                        <div class="dynamic-field-group hidden" data-required-for="meeting:virtual video call,meeting:in-person meeting">
                            ...
                            <textarea name="details[participants]" rows="3" class="dynamic-required w-full border-gray-300 rounded" data-required-when-visible="true" placeholder="Enter one participant per line">{{ old('details.participants') }}</textarea>
                        ...
                        <div class="dynamic-field-group hidden" data-required-for="communication:text,communication:email,communication:call">
                            ...
                            <input type="text" name="details[person]" value="{{ old('details.person') }}" class="dynamic-required w-full border-gray-300 rounded" data-required-when-visible="true">
                        </div>
                        ...
                        <div class="dynamic-field-group hidden" data-required-for="supplies:order,supplies:pick up,supplies:return,supplies:exchange,supplies:buy in store">
                            ...
                            <input type="text" name="details[company]" value="{{ old('details.company') }}" class="dynamic-required w-full border-gray-300 rounded" data-required-when-visible="true">
                            ...
                            <div class="mt-4">
                                ...
                                <div id="supply_items" class="space-y-3">
                                    <div class="supply-item-row" style="display: grid; grid-template-columns: minmax(0, 1fr) 80px auto; align-items: center; gap: 12px;">
                                        <input type="text" name="details[items][0][name]" class="supply-item-input w-full border-gray-300 rounded" placeholder="Item name">
                                        <input type="number" name="details[items][0][quantity]" class="supply-item-input w-full border-gray-300 rounded text-center" placeholder="#" min="1" step="1">
                        ...
                        <div class="dynamic-field-group hidden" data-required-for="logistics:coordinate workers">
                            ...
                            <textarea name="details[workers]" rows="3" class="dynamic-required w-full border-gray-300 rounded" data-required-when-visible="true" placeholder="Enter one worker per line">{{ old('details.workers') }}</textarea>

                            <div class="mt-4">
                                <label class="block font-medium">Project</label>
                                <input type="text" name="details[project]" value="{{ old('details.project') }}" class="dynamic-required w-full border-gray-300 rounded" data-required-when-visible="true">
                            </div>

                            <div class="mt-4">
                                <label class="block font-medium">Estimated Due Date</label>
                                <input type="date" name="details[estimated_due_date]" value="{{ old('details.estimated_due_date') }}" class="dynamic-required w-full border-gray-300 rounded" data-required-when-visible="true">
                            </div>

                            <div class="mt-4">
                                <label class="block font-medium">Location</label>
                                <input type="text" name="details[logistics_location]" value="{{ old('details.logistics_location') }}" class="dynamic-required w-full border-gray-300 rounded" data-required-when-visible="true">
                            </div>
                        </div>

                        <div class="dynamic-field-group hidden" data-required-for="logistics:lead-team member meeting">
                            <label class="block font-medium">Worker(s)</label>
                            <textarea name="details[team_workers]" rows="3" class="dynamic-required w-full border-gray-300 rounded" data-required-when-visible="true" placeholder="Enter one worker per line">{{ old('details.team_workers') }}</textarea>
                        </div>
                        ...
                        <div class="dynamic-field-group hidden" data-required-for="estimate/invoice:send,estimate/invoice:change price,estimate/invoice:change details,estimate/invoice:create an add-on">
                            ...
                            <select name="details[invoice_or_estimate]" class="dynamic-required w-full border-gray-300 rounded" data-required-when-visible="true">
                                ...
                                <option value="Invoice" @selected(old('details.invoice_or_estimate') === 'Invoice')>Invoice</option>
                                <option value="Estimate" @selected(old('details.invoice_or_estimate') === 'Estimate')>Estimate</option>
                            </select>

                            <div class="mt-4">
                                <label class="block font-medium">Number</label>
                                <input type="text" name="details[number]" value="{{ old('details.number') }}" class="dynamic-required w-full border-gray-300 rounded" data-required-when-visible="true">
                            </div>

                            <div class="mt-4">
                                <label class="block font-medium">Name</label>
                                <input type="text" name="details[name]" value="{{ old('details.name') }}" class="dynamic-required w-full border-gray-300 rounded" data-required-when-visible="true">
                            </div>
                        </div>
                        ...
                        <div class="dynamic-field-group hidden" data-required-for="payment:routine payment,payment:payment due,payment:cash checks,payment:register payment,payment:ask for payment">
                            <div class="grid gap-4 md:grid-cols-2">
                                <div>
                                    ...
                                    <input type="number" name="details[payment_amount]" value="{{ old('details.payment_amount') }}" class="dynamic-required w-full border-gray-300 rounded" data-required-when-visible="true" placeholder="0.00" min="0" step="0.01">
                                </div>

                                <div>
                                    <label class="block font-medium">Payment Date / Due Date</label>
                                    <input type="date" name="details[payment_date]" value="{{ old('details.payment_date') }}" class="dynamic-required w-full border-gray-300 rounded" data-required-when-visible="true">
                                </div>
                            </div>
                            ...
                            <div class="mt-4 grid gap-4 md:grid-cols-2">
                                <div>
                                    ...
                                    <input type="text" name="details[payment_document_number]" value="{{ old('details.payment_document_number') }}" class="dynamic-required w-full border-gray-300 rounded" data-required-when-visible="true">
                                </div>

                                <div>
                                    <label class="block font-medium">Project / Client Name</label>
                                    <input type="text" name="details[payment_name]" value="{{ old('details.payment_name') }}" class="dynamic-required w-full border-gray-300 rounded" data-required-when-visible="true">
                                </div>
                            </div>
                            ...
                            <div class="mt-4 grid gap-4 md:grid-cols-2">
                                <div>
                                    ...
                                    <select name="details[payment_method]" class="dynamic-required w-full border-gray-300 rounded" data-required-when-visible="true">
                                        <option value="">-- Select --</option>
                                        <option value="Cash" @selected(old('details.payment_method') === 'Cash')>Cash</option>
                                        <option value="Check" @selected(old('details.payment_method') === 'Check')>Check</option>
                                        <option value="Card" @selected(old('details.payment_method') === 'Card')>Card</option>
                                        <option value="ACH / Bank Transfer" @selected(old('details.payment_method') === 'ACH / Bank Transfer')>ACH / Bank Transfer</option>
                                        <option value="Other" @selected(old('details.payment_method') === 'Other')>Other</option>
                                    </select>
                                </div>
                                ...
                                <div>
                                    ...
                                    <select name="details[payment_status]" class="dynamic-required w-full border-gray-300 rounded" data-required-when-visible="true">
                                        <option value="">-- Select --</option>
                                        <option value="Pending" @selected(old('details.payment_status') === 'Pending')>Pending</option>
                                        <option value="Requested" @selected(old('details.payment_status') === 'Requested')>Requested</option>
                                        <option value="Received" @selected(old('details.payment_status') === 'Received')>Received</option>
                                        <option value="Deposited" @selected(old('details.payment_status') === 'Deposited')>Deposited</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                    ...
                    <div id="all_day_date_group" class="mb-4 hidden">
                        <label class="block font-medium">To-Do Date</label>
                        <input id="all_day_date" type="date" name="all_day_date" value="{{ old('all_day_date') }}" class="w-full border-gray-300 rounded">
                    </div>
...
<script>
    ...
    const oldSubtype = @json(old('event_subtype'));
