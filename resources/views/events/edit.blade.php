                ...
                <form method="POST" action="{{ route('events.update', $event) }}">
                    ...
                    <div id="any_time_todo_group" class="mb-4 rounded-lg border border-blue-100 bg-blue-50 p-4">
                        <label class="flex items-start gap-3 font-medium text-gray-800">
                            <input type="hidden" name="is_all_day_todo" id="forced_is_all_day_todo" value="{{ old('is_all_day_todo', $isReminderEvent || $isAllDayTodoEvent) ? '1' : '0' }}">
                            <input id="is_all_day_todo" type="checkbox" name="is_all_day_todo" value="1" class="mt-1 rounded border-gray-300" @checked(old('is_all_day_todo', $isReminderEvent || $isAllDayTodoEvent))>
                            <span>
